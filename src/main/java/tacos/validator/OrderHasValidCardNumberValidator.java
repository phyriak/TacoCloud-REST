...
public class OrderHasValidCardNumberValidator implements ConstraintValidator<OrderHasValidCardNumber, String> {


/*    @Autowired
    private OrderHasValidCardNumberValidatorHelper helper;*/

    @Override
    public void initialize(OrderHasValidCardNumber constraintAnnotation) {
